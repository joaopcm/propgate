 ...
 *
 * The two 400 bodies were produced by running the real `signupSchema` from
...
export const SIGNUP_RESPONSE = `{ "data": { "object": "signup", "status": "pending" }, "error": null, "meta": null }`;

export const SIGNUP_MISSING_EMAIL_400 = `{ "data": null, "error": { "message": "email: Invalid input: expected string, received undefined" }, "meta": null }`;

export const SIGNUP_SHORT_EMAIL_400 = `{ "data": null, "error": { "message": "email: Too small: expected string to have >=3 characters" }, "meta": null }`;

export const SIGNUP_RATE_LIMIT_429 = `{ "data": null, "error": { "message": "too many signup requests; try again in 2117s" }, "meta": null }`;
